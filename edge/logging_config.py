"""Configuración estándar de logging para edge/.
...
def setup_logging() -> None:
    ...
    Escribe simultáneamente a consola (para ver en vivo) y a `logs/edge.log`
    (para revisar después), con nivel mínimo INFO para no generar ruido
    excesivo con mensajes DEBUG.
    """
    global _configured
    if _configured:
        return
